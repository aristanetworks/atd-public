...
Device Menu:            Lab Controls
   ...
   1. Spine1              13. Reset All Devices to Base (reset)
   2. Spine2
   3. Leaf1               The following options will configure all devices in the lab except leaf4
   4. Leaf2               14. MLAG Lab (mlag)
   5. Leaf3               15. BGP Lab (bgp)
   6. Leaf4               16. VXLAN Lab (vxlan) excludes leaf3 instead of leaf4
   7. Host1               17. EVPN Type 2 Lab (l2evpn) excludes leaf3 instead of leaf4
   8. Host2               18. EVPN Type 5 Lab (l3evpn) excludes leaf3 instead of leaf4
   9. CVX                 19. CVP lab (cvp)
   10. Screen (screen) -  20. Broadcast Engineer Training (media)
   11. Shell (bash)
   12. Exit/Quit (exit)
    """)
    ...
    if ans=="1" or ans=="spine1":
      ...
      os.system("./pushHostDefaultConfig.sh")
      ...
      os.system("./pushHostMediaConfig.sh")
      os.system("./media.py")
    elif ans=="exit":
      quit()
    elif ans !="":
