...
def resetDevices( server,topology,excludeList):
   ...
   l1 = [ "Leaf1-MLAG-Lab","Leaf1-BGP-Lab","Leaf1-VXLAN-Lab","Leaf1-L2EVPN-Lab","Leaf1-L3EVPN-Lab","Leaf1-BGP-Lab","media-leaf1-IP-Intro-start","media-leaf1-VLAN-STP-start","media-leaf1-OSPF-start","media-leaf1-BGP-start","media-eaf1-Multicast-lab" ]
