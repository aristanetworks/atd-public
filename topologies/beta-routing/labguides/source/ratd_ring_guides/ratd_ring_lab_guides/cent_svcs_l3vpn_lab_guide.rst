...
#. If you did not fully complete the previous Customer-4 L3VPN Setup lab, log into the **LabAccess** jumpserver to prepare 
   ...
   #. Type ``centsvc-ring`` or Lab Option 8 at the Ring Routing Labs prompt. The script will configure the topology with 
      the necessary base IPv4 addressing, IS-IS IGP, enable SR extensions for MPLS and BGP EVPN as well as the Customer-1 
      and Customer-4 L3VPNs.
